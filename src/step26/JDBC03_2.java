 ...
 * => SQL문을 만들 때 값이 들어갈 자리를 비워둔 채 만든다.
 *    SQL문을 만든 후 값을 따로 넣는다.
 ...
 * 
 * 실행할 때 마다                              :미리 SQL을 컴파일 해 두었다가
 * SQL을 컴파일하여 서버에 전달                 값을 첨부하여 서버에 전달
...
public class JDBC03_2 {
  public static void main(String[] args) throws Exception {
    ...
    try (
        ...
        PreparedStatement stmt = con.prepareStatement("update ex_contacts set tel=?, position=? where email=?");
