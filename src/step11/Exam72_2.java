/* 상속과 다형성 - 다형적 변수와 메서드 오버라이딩*/
package step11;

public class Exam72_2 {
  static class A {
    int v1;
    void m1() {
  ...
  public static void main(String[] args) {
    ...
    //=>자바 컴파일러는 단순하다. 레퍼런스가 무엇을 가리키고 있는지는 따지지 않고
...
/*
#레퍼런스의 사용범위를 검사 할때,
  컴파일러는 그 레퍼런스의 타입에 따라 사용가능한 변수/메서드인지 검사한다.
- 다형적 변수의 특징에 따라 다음의 경우처럼
  A p = new C();
  레퍼런스 변수 p에 실제 C 인스턴스의 주소가 저장되었을 지라도
