/* 상속과 다형성 - 오버라이딩(overriding) 검사하기 */
package step11;

public class Exam73_3 {
  static class A {
    int v1;
...
-컴파일러나 JVM이 이 주석을 참조하여 지정된 작업을 수행한다.
-문법
  @에노테이션이름(속성=값,속성=값,....)
