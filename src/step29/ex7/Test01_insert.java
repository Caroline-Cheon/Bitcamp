...
public class Test01_insert {
  public static void main(String[] args) throws Exception {
    ...
    teacher.setName("조정석2강사");
    teacher.setEmail("jeongseok2@test.com");
    teacher.setTel("1111-1114");
    teacher.setPassword("1111");
    teacher.setHomepage("jeongseok.test.com");
    teacher.setFacebook("facebook.com/jeongseok");
    teacher.setTwitter("twitter.com/jeongseok");
