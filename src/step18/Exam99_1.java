...
=> Generalization(일반화)
  - 서브 클래스의 공통 분모를 뽑아서 수퍼클래스로 정의하는 것
...
=> Specialization(특수화)
  ...
  - 즉 상속 받기 위해 수퍼 클래스를 잘 만들어야 한다는 강박에서 벗어나라!
    ...
    공통점이 보이면 그때 가서 수퍼 클래스를 정의해도 늦지 않다.
*/
package step18;
...
public class Exam99_1 {
  ...
  public static void main(String[] args) throws Exception{
    ...
    // FilterInputStream a = new FilterInputStream();
    // System.out.pritnln(a.read());
    // error : FilterInputStream is abstract; cannot be instantiated
    // FilterInputStream은 추상 클래스이기때문에 인스턴스를 만들 수 없다.
