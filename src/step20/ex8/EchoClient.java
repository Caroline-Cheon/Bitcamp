/* 주제: 네트워킹 프로그래밍 소개 - echo client 만들기(Thread 적용)
 * 클라이언트는 스레드를 위해 변경할 것이 없다.
*/
package step20.ex8;
...
public class EchoClient {
  public static void main(String[] args) throws Exception {
    ...
    do {
      ...
      out.println(message); // 서버에 한 줄 메세지를 보냄.
      System.out.println(in.nextLine()); // 서버로부터 받은 한 줄 메세지를 읽음
