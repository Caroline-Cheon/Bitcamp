/*주제: 리플렉션API 사용법 - 로딩된 클래스의 정보 얻기 I
 * 1) Class.forName()의 return값
 *    => forName()은 클래스를 로딩하기도 하지만,
 *       그 클래스 정보를 다룰 수 있는 객체(도구)를 리턴하기도 한다.
 * 
 * *****3 개의 방법 중에서 가장 많이 쓰인다.why? 사용자 입력으로 클래스 이름을 받을 수 있기 때문이다.
 */
package step24;
...
public class ClassTest02 {
  ...
  public static void main(String[] args) throws Exception{
    ...
    //    "?"의 의미? Class 도구가 다룰 수 있는 클래스는 아무거나 가능하다는 의미다.
    Class<?> c3 = Class.forName("step24.ClassTest01$MyClass");
    c3 = Class.forName("java.lang.String");
    
    // forName()에 중첩클래스를 지정할 때는 '.' 대신 클래스 파일명인 $를 지정해야한다.
