/* 역할: 문자열을 Engine 객체로 변환시켜주는 에디터 만들기.
 ...
 *    개발자에게 쓰라고 제공해주는 도우미 클래스를 상속받아라
 */
package step28.ex6;
...
public class EngineEditor extends PropertyEditorSupport{
  ...
  // 문자열을 Engine 객체로 변환해야할 때 호출되는 메서드를 재정의 하라!
  @Override
  public void setAsText(String text) throws IllegalArgumentException {
    ...
    // Engine 객체를 값으로 저장한다. 이 객체를 스프링 IoC 컨테이너는 이 객체를 사용할 것이다.
    this.setValue(obj);
  }
