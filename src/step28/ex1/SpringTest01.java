...
public class SpringTest01 {
  public static void main(String[] args) {
     ...
     * 1) 부트스트랩(bootstrap) - JRE에서 제공하는 클래스. jre/lib 폴더를 찾는다.
     * 2) JRE 확장 라이브러리 - JRE의 lib/ext 폴더를 찾는다.
     * 3) CLASSPATH - OS 환경 변수의 경로 또는 JVM을 실행할 때 설정한 경로를 찾는다.
     * 
