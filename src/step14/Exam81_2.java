...
public class Exam81_2 {
  ...
  public static void main(String[] args) throws Exception {
    // try블록 안에서 발생되는 모든 예외를 개별적으로 받을 수 있다.
    try {
      m1(); m2(); m3(); m4();
    } catch (IOException e) {
    } catch (FileNotFoundException e) { //위의 IOException 변수 때문에 잡을 수 없다.
    } catch (EOFException e) { //위의 IOException 변수 때문에 잡을 수 없다.
    } catch (Exception e) {
    }
