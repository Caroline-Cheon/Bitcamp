 ...
 *               애노테이션을 정의한 후 유지 정책을 지정하지 않으면 CLASS가 기본이다.
 *    - RUNTIME : 컴파일 한 후에도 .class 에 존재한다.
...
public class Test03 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (anno != null) {
      System.out.println("MyAnnotaion 추출 성공!");
    }
    if (anno2 != null) {
      System.out.println("MyAnnotaion2 추출 성공!");
    }
    if (anno3 != null) {
      System.out.println("MyAnnotaion3 추출 성공!");
    }
  }
}
